...
class CodeGenerator(NodeVisitor):
    ...
    #: function's output for settings.
    _default_finalize = text_type
    _finalize = None

    def _make_finalize(self):
        """Build the finalize function to be used on settings and at
    ...
    def visit_Output(self, node, frame):
        ...
        # Evaluate settings at compile time if possible. Each item in
        ...
        for child in node.nodes:
            try:
                if not (
                    ...
                    # settings can't be evaluated at compile time.
                    finalize.const
