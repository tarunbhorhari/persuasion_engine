...
_kwargs_error = TypeError(
    ...
    "- A function or custom_lambda accepting no arguments and returning the value that "
    ...
    "Wrapping non-immutable values in a function / custom_lambda allows the values "
